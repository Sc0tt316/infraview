...
// Mock data
const statData = [
  { id: 1, title: "Total Printers", value: 18, change: "+2", percent: "12%", trend: "up", icon: Printer, color: "blue" },
  { id: 2, title: "Active Users", value: 245, change: "+15", percent: "8%", trend: "up", icon: Users, color: "green" },
  { id: 3, title: "Print Jobs (Today)", value: 578, change: "-35", percent: "4%", trend: "down", icon: FileText, color: "purple" },
  { id: 4, title: "Alerts", value: 7, change: "+3", percent: "20%", trend: "up", icon: Bell, color: "amber" }
];
            ...
            <CardFooter>
              <div className="w-full flex justify-between text-sm text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <span>{printerStatusData[0].value} Online</span>
                </div>
                <div className="flex items-center gap-1">
                  <XCircle className="h-3 w-3 text-gray-600" />
                  <span>{printerStatusData[1].value} Offline</span>
                </div>
                <div className="flex items-center gap-1">
                  <AlertTriangle className="h-3 w-3 text-red-600" />
                  <span>{printerStatusData[2].value} Errors</span>
                </div>
              </div>
            </CardFooter>
          </Card>
