      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-card border rounded-lg p-4">
          ...
          <div className="space-y-4">
            <StatusLevels inkLevel={printer.inkLevel} paperLevel={printer.paperLevel} supplies={printer.supplies} status={printer.status} subStatus={printer.subStatus} />
        ...
        {/* Statistics */}
        <div className="bg-card border rounded-lg p-4">
          <PrinterStatistics stats={printer.stats} jobCount={printer.jobCount} lastActive={printer.lastActive} />
        </div>
      </div>
    </div>;
};
